...
source_file: "https://www.agriculture.bf/offensive-agropastorale-et-halieutique-2023-2025/"
source_id: "bf_maerah_oaph_orientation_2026"
source_url: "https://www.agriculture.bf/offensive-agropastorale-et-halieutique-2023-2025/"
...
- Limite terrain: ce n'est **pas** un manuel INERA. Pour les doses, maladies et
  ...
  local valide.
- Contact public indique sur le site (a verifier localement):
  dcrp@agriculture.gov.bf ; numero vert (+226) 51 51 34 04.

## Qu'est-ce que le MAERAH ?

Le Ministere de l'Agriculture, de l'Eau, des Ressources Animales et
...
- Projet d'Appui a la Qualification et a la Professionnalisation des Acteurs
  Agricoles (PAQPA)
- Projet de Renforcement de la Modernisation de la Mecanisation Agricole (PR2MA)
- Projet de Resilience a l'Insecurite Alimentaire et Nutritionnelle des
  Personnes Deplacees Internes (PRIAN-PDI)
- Projet de Renforcement des Services de production Agricole par le Numerique
  (PRSAN)
- Projet Agriculture Contractuelle Et Transition Ecologique (PACTE)
- Projet d'Appui a la Gestion du Stock d'Intervention (PAGSI)
- Projet de developpement d'infrastructures agricoles post recolte (PDIAP)
- Projet d'Appui Regional a l'Initiative pour l'Irrigation au Sahel-Burkina
  (PARIIS-BF)
- Projet de resilience et competitivite agricoles du Burkina Faso (PReCA)
- Programme de resilience des systemes alimentaires en Afrique de l'Ouest (PRSA)
- Projet Regional d'Appui au Pastoralisme au Sahel-Burkina Faso (PRAPS-BF 2)
- Projet d'Amelioration de la productivite agricole par la Conservation des
...
- Bibliotheque documentaire du ministere: https://www.agriculture.bf/document-library/
- AgriTube: https://agritube.gov.bf/
- Contacter les services techniques locaux ou un agent de vulgarisation pour
  toute decision couteuse (engrais, pesticides, investissement).
