...
- **Deterministic fertilizer guidance** — fixed Burkina reference values (never generated by the
  LLM), with unresolved detailed provenance labelled for agronomist review and a mandatory
  "confirmez avec votre agent" disclaimer. The inconsistent millet microdose equivalents are withheld.
